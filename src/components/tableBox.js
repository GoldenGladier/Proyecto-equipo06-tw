        ...
        if(parseInt(this.props.width) == 2) {   
            boxHeight1 = (
                <div class="col-10 board-column">     
                    ...
                    <div className="col-12 board row">
                        <div class="border-solid col-6">
                            <h4><MathJax mathText={this.props.square2}/></h4>
                        </div>
                        <div class="border-solid col-6">
                            <h4><MathJax mathText={this.props.square1}/></h4>
                        </div>
                    </div>
                </div>  
            );
            boxHeight2 = (
                <div class="col-10 board-column">     
                    ...
                    <div className="col-12 board row">
                        <div class="border-solid col-6 align-middle">
                            <h4><MathJax mathText="101010101"/></h4>                            
                        </div>
                        <div class="border-solid col-6 align-middle">
                            <h4><MathJax mathText={this.props.square4}/></h4>                            
                        </div>
                    </div>
                </div>  
            );
            lineWidth = (
                ...
                { /* (  PARTE SUPERIOR DERECHA ) */ }
                    <div className="top-data-board">
                        <h3><MathJax mathText={this.props.binom1} /></h3>
                        <div className="top-data-line row">
                            <div class="border-solid purple col-6"></div>
                            <div class="border-solid purple col-6"></div>
                        </div>
                        <div className="top-data row">
                            <div class="col col-6"><MathJax mathText={this.props.equation1}/></div>
        ...
        if(parseInt(this.props.height) > 1) {
                ...
                { /* (  PARTE INFERIOR IZQUIERA ) */ }
                        <div className="left-data-line row">
                            ...
                            <div class="col col-11 center-all">
                                <MathJax mathText={this.props.sizeh1} />
                            </div>
                        </div>                        
                </div>
            );            
            ...
            boxHeight2 = (
                <div class="col-10 board-column">     
                    ...
                    <div className="col-12 board row">
                        <div class="border-solid col-6 align-middle">
                            <h4><MathJax mathText={this.props.square3}/></h4>
                        </div>
                        <div class="border-solid col-6 align-middle">
                            <h4><MathJax mathText={this.props.square4}/></h4>                            
                        </div>
